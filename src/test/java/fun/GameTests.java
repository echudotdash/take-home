...
public class GameTests {
    ...
    @Test
    @DisplayName("To verify the status code of the valid data")
    ...
    @Test
    @DisplayName("To verify the status code of the invalid data")
    ...
    @Test
    @DisplayName("To verify the status code with null value")
    ...
    @Test
    @DisplayName("To verify the status code and response when the user doesn't provide any game")
    ...
    @Test
    @DisplayName("To verify the status code and response when the user pass invalid game")
    ...
    @Test
    @DisplayName("To Store the response into data class")
