...
public class GameTests {
	...
	public void testJsonSchema() throws IOException {
		...
		String json = restTemplate
				.exchange(baseUrl, RequestEntity.get(baseUrl).accept(MediaType.APPLICATION_JSON).build(), String.class)
				.getBody();
		JsonSchemaValidator
				.createValidator(resourceLoader.getResource("classpath:game_testResponse.json").getInputStream())
				.validate(json);
	}
