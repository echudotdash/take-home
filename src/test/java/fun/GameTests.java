...
public class GameTests {
    ...
    public void testJsonParsing() throws IOException {
        Resource resource = new ClassPathResource("game-response.json");
    ...
    public void testJsonSchema() throws IOException {
        ...
        JsonSchemaValidator.createValidator(resourceLoader.getResource("classpath:game-schema.json").getInputStream()).validate(json);
    }
}
